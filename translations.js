...
window.translations = {
  pt: {
    ...
    experience: [
      ...
      },
      {
        ...
        description: "Idealizador e líder do Grupo CSV (Cuidados em Saúde com Valor), formado por três empresas — AxiaCare®, MedValor® e Thera® — que unem gestão, educação e tecnologia em um mesmo propósito: gerar transformação real na saúde, com foco em eficiência, conhecimento e cuidado centrado nas pessoas.",
        current: true
      },
      {
    ...
    education: [
      {
        degree: "MBA Administração Hospitalar",
        institution: "Faculdade Unimed",
        period: "jul 2023 – dez 2024"
      },
      {
        degree: "MBA Gestão, Tecnologia e Inovação em Saúde",
        institution: "Pontifícia Universidade Católica do Paraná",
        period: "dez 2024 – dez 2025"
      },
      {
        degree: "MBA Gestão de Qualidade e Acreditação em Saúde",
        institution: "Faculdade Unimed",
        period: "jan 2023 – jun 2024"
      },
      {
        degree: "MBA Gestão de Serviços de Saúde",
        institution: "UniAmérica",
        period: "nov 2021 – jan 2023"
      },
      {
        degree: "Residência Médica em Anestesiologia",
        institution: "Universidade Federal de Juiz de Fora",
        period: "2015 – 2018"
      },
      {
        degree: "Graduação em Medicina",
        institution: "Faculdade de Ciências Médicas e da Saúde de Juiz de Fora (SUPREMA – FCMS/JF)",
        period: "2009 – 2014"
      }
    ],
    certifications: [
  ...
  en: {
    ...
    about: {
      ...
      slide3: "Founder of Grupo CSV (AxiaCare®, MedValor® and Thera®), I am a consultant and speaker with solutions that combine technology, analytics and executive education to transform healthcare services and accelerate innovation. My background and expertise span Hospital Administration, Clinical Governance, Population Health and Value-Based Healthcare (VBHC).",
    ...
    education: [
      {
        degree: "MBA Hospital Administration",
        institution: "Faculdade Unimed",
        period: "Jul 2023 – Dec 2024"
      },
      {
        degree: "MBA Management, Technology and Innovation in Healthcare",
        institution: "Pontifical Catholic University of Paraná",
        period: "Dec 2024 – Dec 2025"
      },
      {
        degree: "MBA Quality Management and Healthcare Accreditation",
        institution: "Faculdade Unimed",
        period: "Jan 2023 – Jun 2024"
      },
      {
        degree: "MBA Healthcare Services Management",
        institution: "UniAmérica",
        period: "Nov 2021 – Jan 2023"
      },
      {
        degree: "Medical Residency in Anesthesiology",
        institution: "Federal University of Juiz de Fora",
        period: "2015 – 2018"
      },
      {
        degree: "Medical Degree",
        institution: "Faculty of Medical and Health Sciences of Juiz de Fora (SUPREMA – FCMS/JF)",
        period: "2009 – 2014"
      }
    ],
    certifications: [
